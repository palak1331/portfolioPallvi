      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8ftgptPpHpBFCA3xycRX_oeOrJPrN9GhOLQ&s" className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.instagram.com/gourishanker700/" target="#">
                {" "}
...
er-gaurishanker-choudhary-337a3a288
">
                {" "}
            ...
            >
              <a href="https://github.com/gaurishanker700" target="#">
                {" "}
