        ...
        <div className={` ${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          <div className="flex gap-5 flex-wrap ">
            ...
            >
              ...
              <h1  style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}  >BCA ,Shimla University</h1>
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}>Himachal Pradesh</h1>
            </div>
            ...
            >
              ...
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}>12th Class H.D.N senior secondery school </h1>
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}>Anandpur(punjab)</h1>
            </div>
            ...
            >
              ...
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}>10th Class, H.D.N senior secondery school</h1>
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}>Anandpur(punjab)</h1>
            </div>
          </div>
